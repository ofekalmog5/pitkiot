...
class WordDatabase {
    ...
    private func loadWords() {
        allWords = [
            ...
            Word(text: "ציפור", category: "בעלי חיים", difficulty: .easy),
            ...
            Word(text: "תרנגול", category: "בעלי חיים", difficulty: .hard),
            Word(text: "הליכסון", category: "בעלי חיים", difficulty: .hard),
            Word(text: "אקדח", category: "בעלי חיים", difficulty: .hard),
            ...
            Word(text: "קביער", category: "אוכל", difficulty: .hard),
